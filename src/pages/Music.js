    ...
    <section id="wrapper">
      ...
      <div className="wrapper">
        <div className="inner">
          ...
          that is woven throughout the lyrics of the songs. From cries of desperation to shouts of joy, Metamorphosis represents the journeys that we take as believers.</p>
