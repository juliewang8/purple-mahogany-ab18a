	...
	print 'It took ' + i + ' iterations to sort the deck.';
					...
					<section>
						...
						<div className="box alt">
							<div className="row gtr-uniform">
								<div className="col-12"><span className="image fit"><img src={								<div className="col-12"><span className="image fit"><img src={https://i.imgur.com/kAz2mcZ.jpeg} alt="" /></span><h3>Amanda Kong</h3></div>
} alt="" /></span><h3>Amanda Kong</h3></div>
						...
						<h4>Left &amp; Right</h4>
						<p><span className="image left"><img src={pic1} alt="" /></span><h3>Amanda Kong</h3></p>
