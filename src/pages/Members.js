          ...
          <h2 className="major align-center">Current members</h2>
             <div className="box alt">
                    <div className="row gtr-uniform aln-center">
                        ...
                        <div className="col-4">
                                <div className="image fit wrap">
                                    <img src="https://i.imgur.com/RuWqUG7.jpg"alt="" className="image fit img"/>
                                        <div className="image fit overlay overlay-primary">
                                            <div class="image fit title">title</div>
            ...
            <div className="row gtr-uniform aln-center">
                        ...
                        <div className="col-4">
                                <div className="image fit wrap">
                                    <img src="https://i.imgur.com/EtnuUaU.jpg"alt="" className="image fit img"/>
                                        <div className="image fit overlay overlay-primary">
                                            <div class="image fit title">title</div>
                        ...
                        <p className="nopadding align-center">Soprano– BU'25</p> <p className="nopadding align-center">she/her</p>
                        </div>

                        <div className="col-4">
                                <div className="image fit wrap">
                                    <img src="https://i.imgur.com/GXtUUhu.jpg"alt="" className="image fit img"/>
                                        <div className="image fit overlay overlay-primary">
                                            <div class="image fit title">title</div>
                        ...
                        <div className="col-4">
                                <div className="image fit wrap">
                                    <img src="https://i.imgur.com/SFo8541.jpg"alt="" className="image fit img"/>
                                        <div className="image fit overlay overlay-primary">
                                            <div class="image fit title">title</div>
                        ...
                        <div className="col-4">
                                <div className="image fit wrap">
                                    <img src="https://i.imgur.com/feGe9ZP.jpg"alt="" className="image fit img"/>
                                        <div className="image fit overlay overlay-primary">
                                            <div class="image fit title">title</div>
                        ...
                        <p className="nopadding align-center">Tenor – BU'22</p> <p className="nopadding align-center">he/his | INFP | Type 2</p>
                        </div>
                        ...
                        <p className="nopadding align-center">Bass/VP – NEU'24</p> <p className="nopadding align-center">he/his</p>
                        </div>
