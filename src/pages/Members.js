          ...
          <h2 className="major align-center">Current members</h2>
             <div className="box alt">
                    <div className="row gtr-uniform aln-center">
                        ...
                        <h3 className="nopadding align-center">Jenna Riedl</h3><p className="less-padding align-center">PRESIDENT</p>
                        <p className="nopadding align-center">Jenna is a junior studying Painting, Art History, and statistics</p>
                        </div>
