        ...
        <div className="inner">
          <h2 className="major align-center">Current members</h2>
            ...
            <div className="row gtr-uniform aln-center">
                        ...
                        <h3 className="nopadding align-center yellow">Jeanette Lau</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <h3 className="nopadding align-center yellow">Amanda Kong</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <h3 className="nopadding align-center yellow">Anabelle Lee</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <h3 className="nopadding align-center yellow">Becks Loo</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <h3 className="nopadding align-center yellow">Joon Shin</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <h3 className="nopadding align-center yellow">Stefan Wong</h3><p className="lesspadding align-center">PUBLIC RELATIONS CHAIR</p>
                        <p className="nopadding align-center">Alto – NEU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
            </div>
