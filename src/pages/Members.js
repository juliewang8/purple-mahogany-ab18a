          ...
          <h2 className="major align-center">Current members</h2>
             <div className="box alt">
                    <div className="row gtr-uniform aln-center">
                        ...
                        <p className="nopadding align-center">Soprano – BU'23</p> <p className="nopadding align-center">she/her | INFJ-A | Type 9</p>
                        </div>
                        ...
                        <p className="nopadding align-center">Bass/VP – BU'23</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <p className="nopadding align-center">Soprano – NEU'24</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
            ...
            <div className="row gtr-uniform aln-center">
                        ...
                        <h3 className="nopadding align-center yellow">Jeanette Lau</h3>
                        <p className="nopadding align-center">Soprano/Alto – NEU'24</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <p className="nopadding align-center">Alto – BU'22</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <p className="nopadding align-center"> – BU'22</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
                        ...
                        <p className="nopadding align-center">Bass – BU'22</p> <p className="nopadding align-center">she/her | ISFP | Type 9</p>
                        </div>
            </div>
