        ...
        <div className="inner">
          <h2 className="major align-center">Current members</h2>
            ...
            <div className="row gtr-uniform aln-center">
                        ...
                        <p className="nopadding align-center">Soprano/Alto – NEU'24</p> <p className="nopadding align-center">she/her | ESFP | Type 2w3</p>
                        </div>
                        ...
                        <p className="nopadding align-center"> – BU'22</p> <p className="nopadding align-center">he/his | INFP | Type 2</p>
                        </div>
