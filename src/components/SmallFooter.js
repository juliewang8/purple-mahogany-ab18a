...
export default function SmallFooter() {
  return (
    <section id="footer">
      ...
      <h3>Follow us!</h3>
      <ul className="icons">
        <li><a href="https://www.facebook.com/BUMustardSeedOfficial" className="icon fa-facebook"><span className="label">Facebook</span></a></li>
        <li><a href="https://www.instagram.com/bu_mustardseed/" className="icon fa-instagram"><span className="label">Instagram</span></a></li>
        <li><a href="https://www.youtube.com/user/bumseed" className="icon fa-youtube"><span className="label">Youtube</span></a></li>
